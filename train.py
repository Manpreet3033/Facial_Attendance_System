...
window = tk.Tk()
window.title("Facial_Recognition Attendance System")
dialog_title = 'QUIT'
    ...
    if(is_number(Id) and name):
        ...
        while(True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite("TrainingImage/"+"TrainingImage\ "+name + "."+Id + '.' +
...
def TrackImages():
    ...
    while True:
        ...
        cv2.imshow('Attendance Marker', im)
...
takeImg = tk.Button(window, text="Register Face", command=TakeImages, fg="red", bg="yellow",
                    width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
takeImg.place(x=200, y=500)
trainImg = tk.Button(window, text="Scan Registered Faces", command=TrainImages, fg="red",
                     bg="yellow", width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
trainImg.place(x=500, y=500)
trackImg = tk.Button(window, text="Attendance", command=TrackImages, fg="red",
                     bg="yellow", width=20, height=3, activebackground="Red", font=('times', 15, ' bold '))
